function Update-ProductRollout
{
    ...
    $existingRollout = Get-SubmissionRollout -ProductId $productId -SubmissionId $SubmissionId -AccessToken $AccessToken -Verbose:$useVerbose -NoStatus
    ...
    $productPackages = Get-ProductPackage -ProductId $productId -SubmissionId $SubmissionId -AccessToken $AccessToken -Verbose:$useVerbose
    ...
    if ($RolloutAction -eq "set")
    {
        Update-SubmissionRollout -ProductId $productId -SubmissionId $SubmissionId -Percentage $RolloutValue -AccessToken $AccessToken -Verbose:$useVerbose -NoStatus
    }
    else 
    {
        $status = [string]::Empty
        ...
        Update-SubmissionRollout -ProductId $productId -SubmissionId $SubmissionId -State $rolloutActionToStatusMapping[$status] -AccessToken $AccessToken -Verbose:$useVerbose -NoStatus
